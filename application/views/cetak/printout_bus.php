...
<body>
    ...
    <center>
        <table style="width: 50%; border: 1px solid black; border-collapse: collapse; margin-top:30px;">
            <tbody>
                <tr>
                    <td class="border">Nomor Plat Kendaraan</td>
                    <td class="border"><b><?= $bus->nomor_plat_kendaraan ?></b></td>
                </tr>
                <tr>
                    <td class="border">Nama PO</td>
                    <td class="border"><b><?= $bus->nama_po ?></b></td>
                </tr>
                <tr>
                    <td class="border">Jenis Angkutan</td>
                    <td class="border"><b><?= $bus->jenis_angkutan ?></b></td>
                </tr>
                <tr>
                    <td class="border">Trayek</td>
                    <td class="border"><b><?= $bus->trayek ?></b></td>
                </tr>
            </tbody>
        </table>
    </center>
