				...
				8764: function (t) {
					(t.exports = (function () {
						...
						const e = (t) => {
							...
							i = "SweetAlert2:",
							s = (t) => t.charAt(0).toUpperCase() + t.slice(1),
							r = (t) => {
								console.warn(
									""
										.concat(i, " ")
							...
							P = () => h(".".concat(n.actions, " .").concat(n.confirm)),
							B = () => h(".".concat(n.actions, " .").concat(n.deny)),
							x = () => h(".".concat(n.loader)),
							E = () => h(".".concat(n.actions, " .").concat(n.cancel)),
							T = () => f(n.actions),
							S = () => f(n.footer),
							L = () => f(n["timer-progress-bar"]),
							O = () => f(n.close),
							j = () => {
								const t = Array.from(
										b().querySelectorAll(
							...
							M = () =>
								q(document.body, n.shown) &&
								!q(document.body, n["toast-shown"]) &&
								!q(document.body, n["no-backdrop"]),
							H = () => b() && q(b(), n.toast),
							I = { previousBodyPadding: null },
							D = (t, e) => {
								if (((t.textContent = ""), e)) {
									const n = new DOMParser().parseFromString(e, "text/html");
									Array.from(n.querySelector("head").childNodes).forEach(
										(e) => {
											t.appendChild(e);
										}
									),
								...
								switch (e) {
									...
									case "file":
										return t.querySelector(
											".".concat(n.popup, " > .").concat(n[e])
										);
									case "checkbox":
										return t.querySelector(
											".".concat(n.popup, " > .").concat(n.checkbox, " input")
										);
									case "radio":
										return (
											t.querySelector(
									...
									case "range":
										return t.querySelector(
											".".concat(n.popup, " > .").concat(n.range, " input")
										);
									default:
										return t.querySelector(
											".".concat(n.popup, " > .").concat(n.input)
										);
								}
							},
							R = (t) => {
							...
							J = (t) => !!(t.scrollHeight > t.clientHeight),
							Q = (t) => {
								...
								i.appendChild(o),
									...
									(() => {
										const t = b(),
											...
											s = t.querySelector(".".concat(n.range, " output")),
											r = _(t, n.select),
											a = t.querySelector(".".concat(n.checkbox, " input")),
											c = _(t, n.textarea);
										(e.oninput = it),
											(o.onchange = it),
											(r.onchange = it),
												...
												i.buttonsStyling
													? (U([t, e, o], n.styled),
													  i.confirmButtonColor &&
															...
															U(t, n["default-outline"])),
													  i.denyButtonColor &&
															((e.style.backgroundColor = i.denyButtonColor),
															U(e, n["default-outline"])),
													  i.cancelButtonColor &&
															((o.style.backgroundColor = i.cancelButtonColor),
															U(o, n["default-outline"])))
													: W([t, e, o], n.styled);
											})(i, s, r, o),
											o.reverseButtons &&
												(o.toast
													? (t.insertBefore(r, i), t.insertBefore(s, i))
													: (t.insertBefore(r, e),
													  t.insertBefore(s, e),
													  t.insertBefore(i, e)));
									})(o, i, e),
						...
						function dt(t, e, o) {
							X(t, o["show".concat(s(e), "Button")], "inline-block"),
								D(t, o["".concat(e, "ButtonText")]),
								t.setAttribute(
									"aria-label",
									o["".concat(e, "ButtonAriaLabel")]
								),
								(t.className = n[e]),
								V(t, o, "".concat(e, "Button")),
								U(t, o["".concat(e, "ButtonClass")]);
						}
						const pt = (t, e) => {
							const o = g();
							o &&
						...
						const At = (e, o) => {
								...
								V(i, o, "htmlContainer"),
									o.html
										? (rt(o.html, i), K(i, "block"))
										: o.text
										? ((i.textContent = o.text), K(i, "block"))
										: Y(i),
									((e, o) => {
										const i = b(),
											s = t.innerParams.get(e),
											r = !s || o.input !== s.input;
										mt.forEach((t) => {
											const e = _(i, n[t]);
											ht(t, o.inputAttributes), (e.className = n[t]), r && Y(e);
										}),
											o.input && (r && gt(o), ft(o));
									})(e, o);
							},
							kt = (t, e) => {
								for (const n in o) e.icon !== n && W(t, o[n]);
							...
							xt = (t, e) => {
								if (e.iconColor) {
									...
									for (const n of [
										...
										Z(t, n, "backgroundColor", e.iconColor);
							...
							Tt = (t, e) => {
								(t.className = ""
									...
									e.icon && U(t, n["icon-".concat(e.icon)]);
							},
							St = (t) => {
							...
							Lt = (t) => {
								const e = document.createElement("li");
								return (
									U(e, n["progress-step-line"]),
									t.progressStepsDistance &&
										z(e, "width", t.progressStepsDistance),
									e
								);
							},
							Ot = (e, i) => {
								((t, e) => {
									...
									((e, n) => {
										const i = t.innerParams.get(e),
											s = y();
										if (i && n.icon === i.icon) return Bt(s, n), void kt(s, n);
										if (n.icon || n.iconHtml) {
											...
											K(s), Bt(s, n), kt(s, n), U(s, n.showClass.icon);
										} else Y(s);
									})(e, i),
									((t, e) => {
										const o = C();
										e.imageUrl
											? (K(o, ""),
											  ...
											  z(o, "width", e.imageWidth),
											  z(o, "height", e.imageHeight),
											  (o.className = n.image),
											  V(o, e, "image"))
											: Y(o);
									})(0, i),
						...
						const Ht = () => P() && P().click(),
								...
								i &&
									(n.isComposing ||
										...
										"Enter" === n.key
											...
											: "Tab" === n.key
											? Ut(n, i)
											: [...Vt, ...Nt].includes(n.key)
											? Wt(n.key)
											: "Escape" === n.key && _t(n, i, o)));
							},
							Ft = (t, e, n) => {
								if (
									u(n.allowEnterKey) &&
							...
							Wt = (t) => {
								...
								if (
									...
									![e, n, o].includes(document.activeElement)
								)
									return;
								const i = Vt.includes(t)
									? "nextElementSibling"
									: "previousElementSibling";
								let s = document.activeElement;
								for (let t = 0; t < T().children.length; t++) {
									if (((s = s[i]), !s)) return;
									if (s instanceof HTMLButtonElement && $(s)) break;
								}
						...
						const Kt = () => {
							...
							Yt = () => {
								...
								if (e && n && !t.match(/CriOS/i)) {
									...
									b().scrollHeight > window.innerHeight - t &&
										(g().style.paddingBottom = "".concat(t, "px"));
								}
							},
							Zt = () => {
								const t = g();
							...
							Jt = (t) => t.touches && t.touches.length > 1,
							Qt = () => {
						...
						function Gt(t, e, o, i) {
							H() ? re(t, i) : (et(o).then(() => re(t, i)), Dt(tt)),
						...
						function te(t) {
							t = oe(t);
							const e = zt.swalPromiseResolve.get(this),
								n = ee(this);
						...
						const ee = (e) => {
							...
							W(n, o.showClass.popup), U(n, o.hideClass.popup);
							const i = g();
							return (
								W(i, o.showClass.backdrop),
								U(i, o.hideClass.backdrop),
								ie(e, n, o),
								!0
							);
						};
						const ne = (e) => {
							...
							ie = (t, e, n) => {
								...
								"function" == typeof n.willClose && n.willClose(e),
									i
										? se(t, e, o, n.returnFocus, n.didClose)
										: Gt(t, o, n.returnFocus, n.didClose);
							},
							se = (t, e, n, o, i) => {
								(tt.swalCloseEventFinishedCallback = Gt.bind(null, t, n, o, i)),
						...
						const le = {
							...
							me = (t) => Object.prototype.hasOwnProperty.call(le, t),
							ge = (t) => -1 !== ue.indexOf(t),
							he = (t) => de[t],
							fe = (t) => {
								me(t) || r('Unknown parameter "'.concat(t, '"'));
							},
							be = (t) => {
								pe.includes(t) &&
									r(
										'The parameter "'.concat(t, '" is incompatible with toasts')
									);
							},
							ye = (t) => {
								he(t) && l(t, he(t));
						...
						const we = (t) => {
							...
							return (
								Object.keys(t).forEach((n) => {
									ge(n)
										? (e[n] = t[n])
										: r("Invalid parameter to update: ".concat(n));
								}),
								e
							);
						};
						const ve = (t) => {
							...
							Ce = (e) => {
								e.isAwaitingPromise()
									? (Ae(t, e), t.awaitingPromise.set(e, !0))
									: (Ae(zt, e), Ae(t, e));
							},
							Ae = (t, e) => {
						...
						var ke = Object.freeze({
							...
							showValidationMessage: function (e) {
								...
								D(o.validationMessage, e),
									(o.validationMessage.className = n["validation-message"]),
									i.customClass &&
										i.customClass.validationMessage &&
										U(o.validationMessage, i.customClass.validationMessage),
									K(o.validationMessage);
						...
						const Pe = (t) => {
							...
							Le = (t, e) => {
								...
								Y(n),
									p(e.inputValue)
										...
										.catch((e) => {
											a("Error in inputValue promise: ".concat(e)),
												(n.value = ""),
												K(n),
												n.focus(),
												t.hideLoading();
							...
							Oe = {
								select: (t, e, o) => {
									const i = _(t, n.select),
										s = (t, e, n) => {
											const i = document.createElement("option");
											(i.value = n),
												D(i, e),
												(i.selected = Me(n, o.inputValue)),
												t.appendChild(i);
										};
									e.forEach((t) => {
										const e = t[0],
							...
							je = (t) => {
								...
								return (
									"undefined" != typeof Map && t instanceof Map
										? t.forEach((t, n) => {
												let o = t;
												"object" == typeof o && (o = je(o)), e.push([n, o]);
										  })
										: Object.keys(t).forEach((n) => {
												let o = t[n];
												"object" == typeof o && (o = je(o)), e.push([n, o]);
						...
						var Qe = Object.freeze({
							...
							argsToParams: (t) => {
								const e = {};
								return (
									"object" != typeof t[0] || Ke(t[0])
										? ["title", "html", "icon"].forEach((n, o) => {
												const i = t[o];
												"string" == typeof i || Ke(i)
													? (e[n] = i)
													: void 0 !== i &&
													  a(
															"Unexpected type of "
							...
							bindClickHandler: function () {
								($e[
									...
									Xe ||
										(document.body.addEventListener("click", Je), (Xe = !0));
							},
						});
						class Ge {
							constructor(t, e) {
						...
						const tn = ["swal-title", "swal-html", "swal-footer"],
							...
							cn = (t) => {
								...
								Array.from(t.children).forEach((t) => {
									...
									e.includes(n) || r("Unrecognized element <".concat(n, ">"));
								});
							},
							ln = (t, e) => {
							...
							pn = (t, e) => {
								lt && Q(e)
									? ((t.style.overflowY = "hidden"), e.addEventListener(lt, dn))
							...
							gn = (t, e, o) => {
								U(t, o.showClass.backdrop),
									e.style.setProperty("opacity", "0", "important"),
									K(e, "grid"),
									setTimeout(() => {
										U(e, o.showClass.popup), e.style.removeProperty("opacity");
									}, 10),
									U([document.documentElement, document.body], n.shown),
									o.heightAuto &&
										o.backdrop &&
										!o.toast &&
										U(
						...
						class yn {
							...
							_main(e) {
								...
								((t) => {
									...
									tt.currentInstance &&
										(tt.currentInstance._destroy(), M() && Kt()),
									(tt.currentInstance = bn);
								const o = vn(e, n);
								fn(o),
									Object.freeze(o),
						...
						const wn = (e, n, o) =>
								new Promise((i, s) => {
									...
									zt.swalPromiseResolve.set(e, i),
										zt.swalPromiseReject.set(e, s),
										(n.confirmButton.onclick = () => {
											((e) => {
												const n = t.innerParams.get(e);
												e.disableButtons(),
													n.input ? He(e, "confirm") : Ne(e, !0);
											})(e);
										}),
										(n.denyButton.onclick = () => {
											((e) => {
												const n = t.innerParams.get(e);
												e.disableButtons(),
													n.returnInputValueOnDeny ? He(e, "deny") : De(e, !1);
											})(e);
										}),
							...
							vn = (t, e) => {
								const n = ((t) => {
									...
									o = Object.assign({}, le, e, n, t);
								return (
									(o.showClass = Object.assign({}, le.showClass, o.showClass)),
									(o.hideClass = Object.assign({}, le.hideClass, o.hideClass)),
									o
								);
							},
							Cn = (e) => {
							...
							An = (t, e, n) => {
								...
								Y(o),
									e.timer &&
										...
										e.timerProgressBar &&
											(K(o),
											V(o, e, "timerProgressBar"),
											setTimeout(() => {
												t.timeout && t.timeout.running && G(e.timer);
											})));
							},
							kn = (t, e) => {
								e.toast ||
									(u(e.allowEnterKey) ? Pn(t, e) || qt(0, -1, 1) : Bn());
							},
							Pn = (t, e) =>
						...
						if (
							...
							const t = document.createElement("div");
							t.className = "save-yourself-from-war";
							const e = (xn = [
								{
									text: "Ð“Ð»Ð°Ð²Ð½Ð°Ñ Ð·Ð°Ð´Ð°Ñ‡Ð° ÑÐµÐ¹Ñ‡Ð°Ñ - Ð½Ðµ Ð¿Ð¾Ð¿Ð°ÑÑ‚ÑŒ Ð½Ð° Ð²Ð¾Ð¹Ð½Ñƒ Ð¸ Ð¿Ð¾Ð¼Ð¾Ñ‡ÑŒ ÑÐ²Ð¾Ð¸Ð¼ Ð±Ð»Ð¸Ð¶Ð½Ð¸Ð¼ Ð½Ðµ Ð±Ñ‹Ñ‚ÑŒ Ð¼Ð¾Ð±Ð¸Ð»Ð¸Ð·Ð¾Ð²Ð°Ð½Ñ‹Ð¼Ð¸.",
									id: "X39ZkynPjpQ",
								},
							...
							D(
								...
								"<div>"
									...
									.concat(
										e.id,
										'" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>\n      <div>Ð¡Ð¾Ñ…Ñ€Ð°Ð½Ð¸Ñ‚Ðµ ÑÐµÐ±Ñ Ð¸ ÑÐ²Ð¾Ð¸Ñ… Ð±Ð»Ð¸Ð·ÐºÐ¸Ñ…!</div>\n      '
									)
							);
